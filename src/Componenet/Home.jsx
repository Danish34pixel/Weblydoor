    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', position: 'relative' }}>
      ...
      <div className='flex gap-4 relative z-10 p-4 justify-center bg-transparent'>
        <style>{`
          ...
          .decrypt-text:hover span.font-bold {
            filter: drop-shadow(0 0 10px rgba(232, 201, 122, 0.7));
            text-shadow: none;
          }
        `}</style>
        <div className='decrypt-text bg-transparent'>
          <h1>
